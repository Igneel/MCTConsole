...
void MagneticFieldDependence::addNoiseToSignals(int coef)
{
    noiseCoef = coef;
    /*
    ...
    {
        coef = coef/100.0*HallEffect[HallEffect.size()-1];
...
void MagneticFieldDependence::GaussianNoiseGenerator(int coef)
{
